...
#Let's use a simple Logistic Regression
...
#4 - Cross-Entropy Cost Computation
...
#Accuracy with different number of hidden units in the hidden layer
...
#Plotting on different planar datasets
